...
export default function ProductCard({ product }) {
  ...
  return (
    <article className="bg-white rounded-xl shadow-sm hover:shadow-md transition overflow-hidden group">
      <Link to={`/products/${product.slug}`} className="block focus:outline-none focus:ring-2 focus:ring-brand-teal rounded-t-xl">
      ...
      <div className="p-4 space-y-2">
        <Link to={`/products/${product.slug}`} className="focus:outline-none focus:ring-2 focus:ring-brand-teal rounded">
